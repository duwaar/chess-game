...
def draw_grid(screen, colors=((255, 255, 255), (0, 0, 0))):
    '''
...
class Board():
    ...
    def highlight(self):
        '''
        Higlights the square underneath the mouse.
        '''
        ...
        for column in self.grid:
            for piece in column:
                ...
                if mouseover:
                    square = position[0], position[1], self.square_size[0], self.square_size[1]
                    pygame.draw.rect(screen, green, square, 4)
                else:
                    pass
